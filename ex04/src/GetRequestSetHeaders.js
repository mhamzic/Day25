...
export class GetRequestSetHeaders extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    fetch("https://api.npms.io/v2/search?q=react", { headers }).then((response) => response.json().then((data) => this.setState({ totalReactPackages: data.total })));
  }
  render() {
